            ...
            <div class="layout-container">
                <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
                    <div class="container-xxl">
                        ...
                        <form action="{{ route('catalog') }}" method="GET" class="navbar-search-wrapper search-input-wrapper container-xxl d-none">
                            @csrf
                                        ...
                                        <ul class="menu-sub">
                                            ...
                                            {{-- <li class="menu-item">
                                                <a href="" class="menu-link">
                                                    <div data-i18n="Declarações & Certificados">Declarações & Certificados</div>
                                                </a>
                                            </li>
                                            <li class="menu-item">
                                                <a href="" class="menu-link">
                                                    <div data-i18n="Dúvidas">Dúvidas</div>
                                                </a>
                                            </li> --}}
                                        </ul>
                                    </li>
                                    ...
                                    @if (Auth::user()->role == 'admin' || Auth::user()->role == 'instructor')
                                        <li class="menu-item">
                                            ...
                                            <ul class="menu-sub">
                                                ...
                                                <li class="menu-item">
                                                    <a href="{{ route('lessons') }}" class="menu-link">
                                                        <div data-i18n="Aulas">Aulas</div>
                                                    </a>
                                                </li>
                                                <li class="menu-item">
                                                ...
                                                <li class="menu-item">
                                                    <a href="{{ route('coupons') }}" class="menu-link">
                                                        <div data-i18n="Cupons">Cupons</div>
                                                    </a>
                                                </li>
                                                <li class="menu-item">
                                                    <a href="{{ route('invoices') }}" class="menu-link">
